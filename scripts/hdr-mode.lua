...
-- This script is Windows-only (requires display-info.dll from mpv-display-plugin)
-- Exit early on non-Windows systems to avoid errors
if not (mp.get_property_native("platform") == "windows") then
    return
end
