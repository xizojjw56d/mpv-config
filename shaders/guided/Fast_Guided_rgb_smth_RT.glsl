...
//!BIND HOOKED
//!SAVE FGF_DOWN_RGB
//!DESC [Fast_Guided_rgb_smth_RT] Downsample
...
//!BIND HOOKED
//!SAVE FGF_DOWN_RGB
//!DESC [Fast_Guided_rgb_smth_RT] Prepare
//!WIDTH HOOKED.w
//!HEIGHT HOOKED.h
//!WHEN STR SUBSAM 1 = *
...
//!BIND FGF_DOWN_RGB
//!SAVE FGF_PROD1
//!DESC [Fast_Guided_rgb_smth_RT] Prodt1
...
//!BIND FGF_DOWN_RGB
//!SAVE FGF_PROD2
//!DESC [Fast_Guided_rgb_smth_RT] Prodt2
//!WIDTH FGF_DOWN_RGB.w
//!HEIGHT FGF_DOWN_RGB.h
//!WHEN STR
...
//!BIND FGF_DOWN_RGB
//!SAVE FGF_PROD3
//!DESC [Fast_Guided_rgb_smth_RT] Prodt3
//!WIDTH FGF_DOWN_RGB.w
//!HEIGHT FGF_DOWN_RGB.h
//!COMPONENTS 1
//!WHEN STR
...
//!BIND FGF_DOWN_RGB
//!SAVE FGF_RGB_H
//!DESC [Fast_Guided_rgb_smth_RT] H-Box RGB
//!WIDTH FGF_DOWN_RGB.w
//!HEIGHT FGF_DOWN_RGB.h
//!WHEN STR
...
//!BIND FGF_PROD1
//!SAVE FGF_PROD1_H
//!DESC [Fast_Guided_rgb_smth_RT] H-Box Prodt1
//!WIDTH FGF_PROD1.w
//!HEIGHT FGF_PROD1.h
//!WHEN STR
...
//!BIND FGF_PROD2
//!SAVE FGF_PROD2_H
//!DESC [Fast_Guided_rgb_smth_RT] H-Box Prodt2
//!WIDTH FGF_PROD2.w
//!HEIGHT FGF_PROD2.h
//!WHEN STR
...
//!BIND FGF_PROD3
//!SAVE FGF_PROD3_H
//!DESC [Fast_Guided_rgb_smth_RT] H-Box Prodt3
//!WIDTH FGF_PROD3.w
//!HEIGHT FGF_PROD3.h
//!COMPONENTS 1
//!WHEN STR
...
//!BIND FGF_RGB_H
//!SAVE FGF_MEAN_RGB
//!DESC [Fast_Guided_rgb_smth_RT] V-Box RGB
//!WIDTH FGF_RGB_H.w
//!HEIGHT FGF_RGB_H.h
//!WHEN STR
...
//!BIND FGF_PROD1_H
//!SAVE FGF_MEAN_PROD1
//!DESC [Fast_Guided_rgb_smth_RT] V-Box Prodt1
//!WIDTH FGF_PROD1_H.w
...
//!BIND FGF_PROD2_H
//!SAVE FGF_MEAN_PROD2
//!DESC [Fast_Guided_rgb_smth_RT] V-Box Prodt2
//!WIDTH FGF_PROD2_H.w
...
//!BIND FGF_PROD3_H
//!SAVE FGF_MEAN_PROD3
//!DESC [Fast_Guided_rgb_smth_RT] V-Box Prodt3
//!WIDTH FGF_PROD3_H.w
...
//!BIND FGF_MEAN_PROD3
//!SAVE FGF_COEF
//!DESC [Fast_Guided_rgb_smth_RT] Coefficients
...
//!BIND FGF_COEF
//!SAVE FGF_COEF_H
//!DESC [Fast_Guided_rgb_smth_RT] H-Box coef
//!WIDTH FGF_COEF.w
//!HEIGHT FGF_COEF.h
//!WHEN STR
...
//!BIND FGF_COEF_H
//!SAVE FGF_MEAN_COEF
//!DESC [Fast_Guided_rgb_smth_RT] V-Box coef
//!WIDTH FGF_COEF_H.w
//!HEIGHT FGF_COEF_H.h
//!WHEN STR
...
//!BIND HOOKED
//!BIND FGF_MEAN_COEF
//!DESC [Fast_Guided_rgb_smth_RT] Fin
//!WHEN STR
...
vec4 hook() {
	...
	float ratio = (p > 0.001) ? (q / p) : 1.0;
	vec3 filtered = I * ratio;
	vec3 result = mix(I, filtered, STR);
